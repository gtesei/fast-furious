...
### transformations 
#trans <- preProcess(X.base, method = c("BoxCox", "center", "scale", "pca") )
#trans <- preProcess(X.base, method = c("center", "scale" , "spatialSign") )
trans <- preProcess(X.base, method = method = c("BoxCox", "center", "scale", "ica") , n.comp = 3000 )
print(trans)
X.base = predict(trans,X.base)
...
## writing on disk 
fn = paste("sub_xgboost_ica_xval" , xval.perf , ".csv" , sep='') 
