...
makeFeatures <- function(train,test,nouns,adjectives,settings) {
  ...
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$qlen)
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$ptlen)
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$pdlen)
  
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$ufos.q)
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$ufos.pt)
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$ufos.same)
  
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$sm)
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$am)
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$amd)
  
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$prtm)
  dtm.tfidf.df = cbind(dtm.tfidf.df , sf$pdm)
  ...
  cat (">>> dtm.tfidf.df dim: ",dim(dtm.tfidf.df)," ... \n")
  cat("***** head featureset ***** \n")
  print(head(dtm.tfidf.df))
  cat("***** tail featureset ***** \n")
  print(tail(dtm.tfidf.df))
...
### make features set 
features.df = makeFeatures (train,test,nouns,adjectives,settings)
