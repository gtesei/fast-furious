...
## ## ## ## ## SVMs
model.grid = build.grid(c(SVM_MEAN_SD_SCALED, SVM_MEAN_SD_REDUCED , SVM_QUANTILES_REDUCED) ,  pca=c(F) )  

## ## ## ## ## LOG
model.grid = rbind ( model.grid , build.grid(c(LOGISTIC_REG_MEAN_SD_SCALED, LOGISTIC_REG_QUANTILES_REDUCED) , pca=c(F) )  )

## ## ## ## ## LDA
model.grid = rbind ( model.grid , build.grid(c(LDA_MEAN_SD_SCALED, LDA_MEAN_SD_REDUCED,LDA_QUANTILES_REDUCED) , pca=c(F) )  )

## ## ## ## ## PLSDA
model.grid = rbind ( model.grid , build.grid(c(PLSDA_QUANTILES_SCALED, PLSDA_MEAN_SD_REDUCED,PLSDA_REG_QUANTILES_REDUCED) , pca=c(F) )  )

## ## ## ## ## NSC
model.grid = rbind ( model.grid , build.grid( c(NSC_MEAN_SD_REDUCED,NSC_REG_QUANTILES_REDUCED) , pca=c(F) )  )
...
## ## ## ## ## CT
model.grid = rbind ( model.grid , build.grid(c(CLASS_TREE_MEAN_SD, CLASS_TREE_MEAN_SD_REDUCED) , pca=c(F) )  )

## ## ## ## ## BOOST     <<<<<<<<<<<
model.grid = rbind ( model.grid , build.grid(c(BOOSTED_TREE_MEAN_SD_SCALED,BOOSTED_TREE_MEAN_SD_REDUCED) , pca=c(F) )  )
