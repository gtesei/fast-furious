...
def get_bidirectional(embed_size = 200 , 
    ...
    x = Bidirectional(GRU(num_lstm, return_sequences=True, dropout=rate_drop_dense, recurrent_dropout=rate_drop_dense))(x)
    #x = Dropout(rate_drop_dense)(x)
...
sample_submission.to_csv("sub_gru7_100e_max_4.csv.gz", index=False , compression='gzip')