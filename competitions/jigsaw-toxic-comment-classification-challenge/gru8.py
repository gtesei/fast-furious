...
EMBEDDING_DIM = 300
we_fn='glove.6B.300d.gensim.up.txt'
...
sample_submission.to_csv("sub_gru9_300eRE_in600_1layer_5.csv.gz", index=False , compression='gzip')