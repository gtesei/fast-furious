...
Xtrain = encodeCategoricalFeature(Xtrain,2,facts.in=facts) ## company

facts = unique(Xtrain$brand)
Xtrain = encodeCategoricalFeature(Xtrain,3,facts.in=facts) ## brand

mi = min(Xtrain$offervalue)
ma = max(Xtrain$offervalue)
Xtrain = nomalize(Xtrain,2,min.in=mi,max.in=ma)

Xtrain = Xtrain[,-1] ## unique 160057 ids 
