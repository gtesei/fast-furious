...
Xtrain = Xtrain[,-5] ## quantity ha il solo valore 1
Xtest = Xtest[,-5] ## quantity ha il solo valore 1

mi = min(c(Xtrain$offervalue,Xtest$offervalue))
ma = max(c(Xtrain$offervalue,Xtest$offervalue))
Xtrain = nomalize(Xtrain,6,min.in=mi,max.in=ma)
Xtest = nomalize(Xtest,6,min.in=mi,max.in=ma)
