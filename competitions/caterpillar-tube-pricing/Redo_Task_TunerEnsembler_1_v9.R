...
ff.bindPath(type = 'ensemble_3' , sub_path = 'dataset/caterpillar-tube-pricing/ensembles/ensemble_3',createDir = TRUE) ## out 
ff.bindPath(type = 'best_tune_3' , sub_path = 'dataset/caterpillar-tube-pricing/ensembles/best_tune_3',createDir = TRUE) ## out 
ff.bindPath(type = 'submission_3' , sub_path = 'dataset/caterpillar-tube-pricing/ensembles/pred_ensemble_3',createDir = TRUE) ## out 
