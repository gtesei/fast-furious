...
validateModelList = function(modelList) {
  ...
  for (i in seq_along(modelList)) {
    ...
    fn = paste(modelList[[i]]$cluster_levs,'_',modelList[[i]]$model.label,useQty,removeHCP,useMaterialId,logLabel,nr2000,nr3000,nr4000,nr5000,power025,power03,power32,
               useL2_10,pickEnsembles,rmsleThreshold,lr,'.csv',sep='')
...
#### on going 
#list(layer = 3 , useLayer = c(T,T,T) , cluster_levs = 1 , model.label = 'xgbTreeGTJ'  , nr4000=T, tune=T, power025=T , predFile = '1_xgbTreeGTJ_power025_nr4000_1_1_1.csv')
####
