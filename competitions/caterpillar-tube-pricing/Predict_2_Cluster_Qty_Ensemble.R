...
reg_train_predict = function( YtrainingSet ,
  ...
  l = tryCatch({
    if (model.label == "LinearReg") {   ### LinearReg
      ...
      #pars n.trees, interaction.depth, shrinkage, n.minobsinnode\n"
      model <- train(y = YtrainingSet, x = XtrainingSet ,
                     method = "gbm",
                     tuneGrid = gbmGrid,
                     bag.fraction = 0.5 , 
  ...
  cat(">> ",model.label,": time elapsed:",secs," secs. [hours:",secs/60,"] [hours:",secs/(60*60),"]\n")
...
reg_models = c("XGBoost" , "LinearReg"  , "KNN_Reg" , "PLS_Reg" , "Enet_Reg" , 
               "SVM_Reg" , "BaggedTree_Reg" , "RandomForest_Reg" , "Cubist_Reg" )
