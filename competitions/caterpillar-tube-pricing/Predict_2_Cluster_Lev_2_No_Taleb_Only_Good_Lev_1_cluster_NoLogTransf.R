...
write.csv(sample_submission,quote=FALSE, 
          file=paste(getBasePath("submission"),'sub_cluster_lev_2_only_good_lev1_clust_no_zero_var_pred_scaled.csv',sep='') ,
          row.names=FALSE)

# sample_submission$cost = pred_real 
# write.csv(sample_submission,quote=FALSE, 
#           file=paste(getBasePath("submission"),'sub_cluster_lev_2_only_good_lev1_clust_real.csv',sep='') ,
#           row.names=FALSE)
