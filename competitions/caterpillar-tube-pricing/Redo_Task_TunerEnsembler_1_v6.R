...
#list(layer = 3 , useLayer = c(T,T,T) , cluster_levs = 1 , model.label = 'xgbTreeGTJ'  , tune=T, power025=T , predFile = '1_xgbTreeGTJ_power025_1_1_1.csv')
...
#                     pickEnsembles = pickEnsembles)
  ml2 = getMetaData(ensembles_dir = ff.getPath('ensemble_3') , 
                    report_fn = report_fn_2,
                    top_perc = top_perc, 
                    rmsleThreshold = rmsleThreshold , 
                    dontTakeInReport = c('best_greedy_8_clusters_2.csv'), 
  ...
  , list(layer = 2 , traindata = ml2$train_meta , testdata = ml2$test_meta)
