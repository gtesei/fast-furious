...
validateModelList = function(modelList) {
  ...
  for (i in seq_along(modelList)) {
    ...
    fn = paste(modelList[[i]]$cluster_levs,'_',modelList[[i]]$model.label,useQty,removeHCP,useMaterialId,logLabel,nr2000,nr3000,nr4000,nr5000,power025,power03,power32,useL2_10,lr,'.csv',sep='')
...
list(layer = 2 , useLayer = c(F,T) , cluster_levs = 1 , model.label = 'ws' ,  predFile = '1_ws_0_1.csv' , tune=F , 
     ensembles = c('1_xgbTreeGTJ_useQty_logLabel_0_1.csv',
                   '1_enet_useL2_10_0_1.csv') , 
