...
validateModelList = function(modelList) {
  ...
  for (i in seq_along(modelList)) {
    ...
    fn = paste(modelList[[i]]$cluster_levs,'_diam_',modelList[[i]]$model.label,useQty,removeHCP,useMaterialId,logFeat,power32Feat,logLabel,nr2000,nr3000,nr4000,nr5000,power025,power03,power32,
               useL2_10,pickEnsembles,rmsleThreshold,pgrade,lr,'.csv',sep='')
...
#list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'pls'  , tune=T, logLabel=T , predFile = '8_xgbTreeGTJ_logLabel.csv') 


# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ'  , tune=T, logLabel=T , predFile = '8_xgbTreeGTJ_logLabel.csv'), 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ'  , tune=T, power025=T , nr4000=T, predFile = '8_xgbTreeGTJ_logLabel.csv'),
# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr4000=T, predFile = '8_xgbTreeGTJ_logLabel.csv')


# list(layer = 1 , useLayer = c(T) , cluster_levs = 3 , model.label = 'xgbTreeGTJ'  , tune=T, logLabel=T , predFile = '8_xgbTreeGTJ_logLabel.csv'), 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 3 , model.label = 'xgbTreeGTJ'  , tune=T, predFile = '8_xgbTreeGTJ_logLabel.csv'), 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 3 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr5000=T, predFile = '8_xgbTreeGTJ_logLabel.csv') 
# 
# 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 4 , model.label = 'xgbTreeGTJ'  , tune=T, logLabel=T , predFile = '8_xgbTreeGTJ_logLabel.csv'), 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 4 , model.label = 'xgbTreeGTJ'  , tune=T, power025=T , nr5000=T, predFile = '8_xgbTreeGTJ_logLabel.csv'), 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 4 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr5000=T, predFile = '8_xgbTreeGTJ_logLabel.csv'),
# 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'cubist'  , tune=T, logLabel=T , predFile = '8_xgbTreeGTJ_logLabel.csv') , 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'cubist'  , tune=T, predFile = '8_xgbTreeGTJ_logLabel.csv') 
 

# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ',nr2000=T,tune=T,logLabel=T , predFile = '8_xgbTreeGTJ_logLabel.csv'), 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTree',tune=T,logLabel=T , predFile = '8_xgbTreeGTJ_logLabel.csv'), 
# list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTree',tune=T, predFile = '8_xgbTreeGTJ_logLabel.csv') 

#list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr3000=T, predFile = '8_xgbTreeGTJ_logLabel.csv'),
#list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr2000=T, predFile = '8_xgbTreeGTJ_logLabel.csv')


#list(layer = 1 , useLayer = c(T) , cluster_levs = 1 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr4000=T, predFile = '8_xgbTreeGTJ_logLabel.csv')
#list(layer = 1 , useLayer = c(T) , cluster_levs = 1 , model.label = 'xgbTreeGTJ'  , tune=T, nr4000=T, predFile = '8_xgbTreeGTJ_logLabel.csv')
#list(layer = 1 , useLayer = c(T) , cluster_levs = 1 , model.label = 'xgbTreeGTJ'  , tune=T, predFile = '8_xgbTreeGTJ_logLabel.csv')

#list(layer = 1 , useLayer = c(T) , cluster_levs = 1 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr3000=T, predFile = '8_xgbTreeGTJ_logLabel.csv')

#list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ'  , tune=T, power32=T , nr4000=T, predFile = '8_xgbTreeGTJ_logLabel.csv'),
#list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'cubist'  , tune=T, power32=T , nr4000=T, predFile = '8_xgbTreeGTJ_logLabel.csv'),
#list(layer = 1 , useLayer = c(T) , cluster_levs = 1 , model.label = 'cubist'  , tune=T, power32=T , predFile = '8_xgbTreeGTJ_logLabel.csv')

#list(layer = 1 , useLayer = c(T) , cluster_levs = 2 , model.label = 'xgbTreeGTJ' , useMaterialId=T , tune=T, power32=T , nr4000=T, predFile = '8_xgbTreeGTJ_logLabel.csv')

#list(layer = 2 , useLayer = c(F,T) , logFeat=T, logLabel=T, cluster_levs = 1 , model.label = 'cubist'  , rmsleThreshold=0.229 , tune=T,   predFile = '1_rlm_useL2_10_0_1.csv')
...
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 2 , model.label = 'pls'  , rmsleThreshold=0.224 , tune=T,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 3 , model.label = 'pls'  , rmsleThreshold=0.224 , tune=T,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 4 , model.label = 'pls'  , rmsleThreshold=0.224 , tune=T,   predFile = '1_rlm_useL2_10_0_1.csv'),

list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 2 , model.label = 'rlm'  , rmsleThreshold=0.224 , tune=F,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 3 , model.label = 'rlm'  , rmsleThreshold=0.224 , tune=F,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 4 , model.label = 'rlm'  , rmsleThreshold=0.224 , tune=F,   predFile = '1_rlm_useL2_10_0_1.csv'),

list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 2 , model.label = 'enet'  , rmsleThreshold=0.224 , tune=T,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 3 , model.label = 'enet'  , rmsleThreshold=0.224 , tune=T,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 4 , model.label = 'enet'  , rmsleThreshold=0.224 , tune=T,   predFile = '1_rlm_useL2_10_0_1.csv'),

list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 2 , model.label = 'bayesglm'  , rmsleThreshold=0.224 , tune=F,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 3 , model.label = 'bayesglm'  , rmsleThreshold=0.224 , tune=F,   predFile = '1_rlm_useL2_10_0_1.csv'),
list(layer = 3 , useLayer = c(F,T,T) , logFeat=T, logLabel=T, cluster_levs = 4 , model.label = 'bayesglm'  , rmsleThreshold=0.224 , tune=F,   predFile = '1_rlm_useL2_10_0_1.csv')
...
for (m in  seq_along(modelList) ) { 
  ...
  ###### TOREMOVE
#   train_set = cbind(train_set,diameterLog = data[[1]]$traindata$diameterLog)
#   train_set = cbind(train_set,diameter1_16 = data[[1]]$traindata$diameter1_16)
#   train_set = cbind(train_set,diameter1_32 = data[[1]]$traindata$diameter1_32)
#   train_set = cbind(train_set,diameter1_2 = data[[1]]$traindata$diameter1_2)
#   train_set = cbind(train_set,diameter1_4 = data[[1]]$traindata$diameter1_4)
#   train_set = cbind(train_set,diameter1_8 = data[[1]]$traindata$diameter1_8)
#   
#   
#   test_set = cbind(test_set,diameterLog = data[[1]]$testdata$diameterLog)
#   test_set = cbind(test_set,diameter1_16 = data[[1]]$testdata$diameter1_16)
#   test_set = cbind(test_set,diameter1_32 = data[[1]]$testdata$diameter1_32)
#   test_set = cbind(test_set,diameter1_2 = data[[1]]$testdata$diameter1_2)
#   test_set = cbind(test_set,diameter1_4 = data[[1]]$testdata$diameter1_4)
#   test_set = cbind(test_set,diameter1_8 = data[[1]]$testdata$diameter1_8)
  ###### end TOREMOVE 
  ...
  if (identical('ensembleAddBias',modelList[[m]]$model.label)) { ##ensembleAddBias
    ...
    res_list = parallel::mclapply( 1:modelList[[m]]$cluster_levs , function(i) {
      ...
      ###
      cat("**** train_set ****\n")
      print(colnames(train_set_cl))
      cat("**** test_set ****\n")
      print(colnames(test_set_cl))
      ####
