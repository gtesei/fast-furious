...
dtrain = xgb.DMatrix(train[feature_names].values, label=y)
...
model = xgb.train(params=xgb_pars, dtrain=dtrain, num_boost_round=1300, evals=(), feval=rmsle_eval,maximize=False, verbose_eval=10)
