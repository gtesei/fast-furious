...
subfn = "base3__val_"+str(model.best_score)+"__rnd_"+str(model.best_iteration)+".csv"
...
print('-----> Submission ... ')
test['log_price'] = model.predict(dtest)
subfn = "base3__all_data__rnd_"+str(model.best_iteration)+".csv"
test[['id', 'log_price']].to_csv(subfn, index=False)
...
subfn = "error__feat_importance_base3.csv" 
