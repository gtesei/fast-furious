...
print(">> final dataset:",all_data.shape) 
...
subfn = "base7_eta0003_val_"+str(model.best_score)+"__rnd_"+str(model.best_iteration)+".csv"
...
print('-----> Submission ... ')
test['log_price'] = model.predict(dtest)
subfn = "base7_eta0003_all_data__rnd_"+str(model.best_iteration)+".csv"
test[['id', 'log_price']].to_csv(subfn, index=False)
...
subfn = "error__feat_importance_base7_eta0003.csv" 
