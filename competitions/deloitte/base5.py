...
xgb_pars = {'min_child_weight': 10, #50
            'eta': 0.005,
...
subfn = "base5base_eta0005__val_"+str(model.best_score)+"__rnd_"+str(model.best_iteration)+".csv"
...
print('-----> Submission ... ')
test['log_price'] = model.predict(dtest)
subfn = "base5baseeta0005__all_data__rnd_"+str(model.best_iteration)+".csv"
test[['id', 'log_price']].to_csv(subfn, index=False)
...
subfn = "error__feat_importance_base5baseeta0005csv" 
