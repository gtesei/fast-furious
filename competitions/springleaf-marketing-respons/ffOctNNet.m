...
dlmwrite(['/Users/gino/kaggle/fast-furious/gitHub/fast-furious/dataset/springleaf-marketing-respons/ensembles/pred_ensemble_1/' id], submission );

%% best tune 
bestTune = [tm AUC p_opt_AUC h_opt_AUC lambda_opt_AUC];
dlmwrite(['/Users/gino/kaggle/fast-furious/gitHub/fast-furious/dataset/springleaf-marketing-respons/ensembles/best_tune_1/' id], bestTune );

%% ensemble 
assemble = [ predTrain ; predTest ];
assemble_id = (1:length(assemble))';
ensemble = [assemble_id assemble];
dlmwrite(['/Users/gino/kaggle/fast-furious/gitHub/fast-furious/dataset/springleaf-marketing-respons/ensembles/ensemble_1/' id], ensemble );
