...
ff.trainAndPredict.class = function(Ytrain ,
  ...
  fastfurious:::checkModelName(model.label,regression=F)
  ...
  trainAndPredictInternal = function(model.label,Ytrain,Xtrain,Xtest,controlObject,removePredictorsMakingIllConditionedSquareMatrix_forLinearModels) {
    ...
    fs = fastfurious:::removePredictorsMakingIllConditionedSquareMatrix_IFFragileLinearModel(Xtrain=Xtrain, 
                                                                                             Xtest=Xtest, 
    ...
    if (model.label == "glm") { ## logistic reg   
      ...
      xgb = fastfurious:::xgb_train_and_predict (train_set = Xtrain,
                                   y = Ytrain,  
                                   test_set = Xtest, 
