[R] Comparing caret regression models in action (... and in practice!)  
========================================================
...
Introduction
--------------------------------------------------------
Here we'll compare regression models in action from __caret R__package. 
The __solubility__ data can be obtained from the  __AppliedPredictiveModeling R__ R package.
Models fitting on train set >10 minutes has been discared. 
Machines: ... 

Performances measure:  __RMSE__ (Root Mean Squared Error) 
