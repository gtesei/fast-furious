...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%% Obiettivo di questa variante è sfruttare il fatto che circa 1/3 delle volte che il 
%%%%%%%% Default Classifier predice 1 è un errore 
%%%%%%%% quindi 1/4 o 1/5 (FREQ1) o ... quando predice 1 lo sostituiamo con 0
%%%%%%%% con FREQ1 = 4 sei su 0.8 .... cassata!!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
_pred_log = (pval > epsilon);


%%%%%%%%%%%%%%%%%%% una volta ogni freq1 se la prediction è 1 mettiamo 0 
