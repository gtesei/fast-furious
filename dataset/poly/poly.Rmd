...
write.table(Xtrain, file="poly_pure_Xtrain.mat", eol="\n",quote=FALSE, col.names=FALSE , row.names=FALSE,sep=",")
write.table(ytrain, file="poly_pure_ytrain.mat", eol="\n",quote=FALSE, col.names=FALSE , row.names=FALSE,sep=",")
write.table(Xval, file="poly_pure_Xval.mat", eol="\n",quote=FALSE, col.names=FALSE , row.names=FALSE,sep=",")
write.table(yval, file="poly_pure_yval.mat", eol="\n",quote=FALSE, col.names=FALSE , row.names=FALSE,sep=",")
```
...
write.table(ypred, file="poly_pure_ypred.mat", eol="\n",quote=FALSE, col.names=FALSE , row.names=FALSE,sep=",")
